                    ...
                    <Row>
                        <Col sm={6}>
                            ...
                            <Form.Group controlId="RegistrationNo">
                                    ...
                                    <Form.Control type="text" name="RegistrationNo" required defaultValue={props.student.enrollment} placeholder="" />
                            </Form.Group>
                            ...
                            <Form.Group controlId="Course">
                                    ...
                                    <Form.Control type="text" name="Course" required defaultValue={props.student.branch} placeholder="" />
                            </Form.Group>
                            <Form.Group controlId="avg_spi">
                                    <Form.Label>Avergae Spi</Form.Label>
                                    <Form.Control type="text" name="avg_spi" required defaultValue={props.student.avg_spi} placeholder="" />
                            </Form.Group>
                            <Form.Group>
                                <p></p>
